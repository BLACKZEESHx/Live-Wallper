...
from PyQt5.QtWidgets import QMainWindow, QLabel, QVBoxLayout, QWidget, QDesktopWidget, QApplication
...
class TimeWindow(QMainWindow):
    def __init__(self):
        ...
        self.timeText.setGeometry(width//2, height//2, self.geometry().width(), self.geometry().height())
        self.mainwidget.setGeometry(width//2, height//2, self.geometry().width(), self.geometry().height())
        self.timeText.setGeometry(width//2, height//2, self.geometry().width(), self.geometry().height())
        self.DateText.setGeometry(width//2, height//2, self.geometry().width(), self.geometry().height())
        # self.show()
        self.raise_()
